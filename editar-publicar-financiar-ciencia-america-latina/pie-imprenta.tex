...
% Comando para marca de agua en todas las páginas del pie de imprenta
\newcommand{\marcaaguapie}{%
...
% Aplicar marca de agua a todas las páginas usando el hook
\AddToHook{shipout/background}{\marcaaguapie}
...
% Desactivar la marca de agua para las páginas siguientes
\RemoveFromHook{shipout/background}{\marcaaguapie}
