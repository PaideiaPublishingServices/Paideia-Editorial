...
\chapterdoi{10.62059/editorial.l001.c1}
\chapterauthors{Lia Machado Fiuza Fialho$^1$, Karla Angélica Nascimento$^1$, Maria Aparecida Alves da Costa$^2$}
\chapteraffiliations{$^1$Universidade Estadual do Ceará, Fortaleza, CE, BR \\ $^2$Instituto Federal de Educação, Ciência e Tecnologia do Ceará, Fortaleza, CE, BR}
...
As instituições de vínculo dos pesquisadores integrantes deste projeto estão apresentas no @tbl-rede1, com a indicação da região geográfica para as brasileiras e do país, no caso das internacionais. 
...
: Instituições envolvidas no projeto {#tbl-rede1}
...
Como no @tbl-rede1, já foram apontadas as instituições envolvidas no projeto, com suas respectivas regiões geográficas, no caso das brasileiras, e dos países, no caso das estrangeiras, especificam-se agora os membros da equipe com as revistas nas quais atuam como editores, bem como seus respectivos grupos de pesquisas implicados no projeto.
...
: Membros da equipe com a indicação das revistas científicas e grupos de pesquisa a que estão vinculados {#tbl-rede2}
...
: Quantitativo de bolsas financiadas {#tbl-rede3}
...
::: {#fig-rede1 layout-ncol=2 layout-valign="center"}

![Logomarca da RIECE](img/riece.png){#fig-rede2}

![Selo de qualidade](img/selo.png){#fig-rede3}
...
: Preservação digital das revistas {#tbl-rede6}
...
: Bases e indexadores das revistas {#tbl-rede7}
...
: Utilização de programas para identificação de similaridade {#tbl-rede8}
...
: Normas que fundamentam a política editorial {#tbl-rede9}
...
: Editores já cadastrados para missão de internacionalização {#tbl-rede10}
...
![QR Code para juntar-se à RIECE](img/qr.png){#fig-rede4}
